# SimpleFM6
A file manager written in PyQt6.
...
SimpleFM6 supports two command line arguments: trash:// for the recycle bin and media://DEVICE (e.g.: media:///dev/sda) for the mass storage devices.
