    ...
    def __init__(self, mainLView):
        try:
            ...
            if os.path.exists(directory_file):
                ...
                btnApply = msgBox.addButton(QMessageBox.StandardButton.Apply)
                btnClose = msgBox.addButton(QMessageBox.StandardButton.Close)
                btnReset = msgBox.addButton(QMessageBox.StandardButton.Reset)
                msgBox.exec()
                #
