...
from PyQt6.QtWidgets import (QFileDialog, QBoxLayout, QPushButton, QApplication, QDialog, QMessageBox, QLineEdit, QWidget, QTreeWidget, QTreeWidgetItem)
...
class listMenu(QWidget):
    ...
    def __init__(self, infile=None):
        ...
        # entry
        hbox2 = QBoxLayout(QBoxLayout.Direction.LeftToRight)
    ...
    def fpopMenu(self):
        ...
        for el in self.menu:
            ...
            witem = self.TWD.findItems(categ, Qt.MatchFlag.MatchExactly, 0)[0]
