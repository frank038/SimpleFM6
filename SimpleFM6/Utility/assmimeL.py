...
from PyQt6.QtCore import (QMargins,QEvent,QObject,Qt)
from PyQt6.QtWidgets import (QDialog, QListWidgetItem, QListWidget, QTreeWidget, QTreeWidgetItem, QBoxLayout,QLabel,QPushButton,QApplication,QDialog,QMessageBox,QLineEdit,QTabWidget,QWidget,QListView)
...
class MainWin(QDialog):
    ...
    def __init__(self, mimetype, parent):
        ...
        # top container
        self.obox = QBoxLayout(QBoxLayout.Direction.LeftToRight)
        self.obox.setContentsMargins(QMargins(2,2,2,2))
        self.setLayout(self.obox)
        # the container
        self.vbox2 = QBoxLayout(QBoxLayout.Direction.TopToBottom)
    ...
    def fitem2(self, imime):
        ...
        witem = self.plist.findItems(defApp, Qt.MatchFlag.MatchExactly, 2)
        if witem:
